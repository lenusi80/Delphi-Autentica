object FrmPrincipal: TFrmPrincipal
  ...
  object Label11: TLabel
    ...
    Width = 142
    Height = 13
    Caption = 'ESC - Cancelar Novo Registro'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clBlue
    Font.Height = -11
    Font.Name = 'Tahoma'
  ...
  object Button4: TButton
    ...
    Width = 75
    Height = 33
    Caption = 'Imprimir Lcto Novamente'
    TabOrder = 6
    TabStop = False
    WordWrap = True
  ...
  object Button5: TButton
    ...
    Width = 103
    Height = 47
    Caption = 'Imprimir Total Acumulado'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Tahoma'
  ...
  object DateTimePicker1: TDateTimePicker
    ...
    Width = 134
    Height = 21
    Date = 0.730171979164879400
    Time = 0.730171979164879400
    TabOrder = 10
  end
  ...
  object DB: TADOConnection
    Connected = True
    ConnectionString = 
      'Provider=Microsoft.Jet.OLEDB.4.0;Data Source=Dados.mdb;Persist S' +
      'ecurity Info=False'
    LoginPrompt = False
  ...
  object Tb_Registros: TADOTable
    Active = True
    Connection = DB
    CursorType = ctStatic
    AfterInsert = Tb_RegistrosAfterInsert
    AfterPost = Tb_RegistrosAfterPost
    TableName = 'Tb_Registros'
    Left = 136
    Top = 308
    object Tb_RegistrosCodigo: TAutoIncField
      FieldName = 'Codigo'
      ReadOnly = True
      DisplayFormat = '000000'
      EditFormat = '000000'
    end
    object Tb_RegistrosValor: TBCDField
      FieldName = 'Valor'
      currency = True
      Precision = 19
    end
    object Tb_RegistrosEspecie: TWideStringField
      Alignment = taCenter
      FieldName = 'Especie'
    end
    object Tb_RegistrosData: TDateTimeField
      FieldName = 'Data'
    end
  end
  object Qr_Registros: TADOQuery
    Active = True
    Connection = DB
    CursorType = ctStatic
    Parameters = <>
    SQL.Strings = (
      'select * from Tb_Registros  order by codigo desc')
    Left = 136
    Top = 340
    object Qr_RegistrosCodigo: TAutoIncField
      DisplayWidth = 12
      FieldName = 'Codigo'
      ReadOnly = True
    end
    object Qr_RegistrosValor: TBCDField
      DisplayWidth = 30
      FieldName = 'Valor'
      currency = True
      Precision = 19
    end
    object Qr_RegistrosEspecie: TWideStringField
      FieldName = 'Especie'
    end
    object Qr_RegistrosData: TDateTimeField
      FieldName = 'Data'
    end
  end
  ...
  object DsQrRegistros: TDataSource
    DataSet = Qr_Registros
    Left = 168
    Top = 340
  end
  ...
  object Matric_Text_Arq1: TMatric_Text_Arq
    Coluna = 0
    Linha = 0
    ImpressaoEmArquivo = False
    AbreArquivoAoFinalizar = False
    Altura = 0
    Opcao = Polegadas
    Left = 88
    Top = 318
