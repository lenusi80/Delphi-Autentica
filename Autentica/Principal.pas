...
type
  TFrmPrincipal = class(TForm)
    ...
    procedure Tb_RegistrosAfterInsert(DataSet: TDataSet);
    procedure Tb_RegistrosAfterPost(DataSet: TDataSet);
  private
  ...
  begin
   case RadioGroup1.ItemIndex of
    ...
    2 : Begin
     ...
     with Matric_Text_Arq1 do
     begin
     showmessage ('Insira o envelope para Autenticação');
     IniciarImpressao;
     TextoC(1,1,mensagem);
     TextoPulaLinha;
     FinalizaImpressao;
...
procedure TFrmPrincipal.Tb_RegistrosAfterInsert(DataSet: TDataSet);
begin
RadioGroup1.Enabled := false;
end;

procedure TFrmPrincipal.Tb_RegistrosAfterPost(DataSet: TDataSet);
begin
